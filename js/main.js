...
function SaveThemeSetup() {
    ...
    if ($('div.main-content')[0].classList[2] == undefined) {
        ...
        objParam.LoginPageName = $('div.main-content')[0].classList[2].replace('screen-', '').replace('Screen-', '');
    }
    ...
    if (data.Code == "1") {
        if (data != null) {
           ...
           var imageUrl = '';
            ...
            $('.login-body .login-block .login-title-block span.icon-lock,.login-body .login-block .login-title-block span.login-txt,.punch .db-btn').css('color', data.colourText);//rgb2hex($('.txt-var .color-block .pickr-child').css('background-color'))
