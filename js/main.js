...
$(document).ready(function() {
  ...
  $('.multi-select .dropdown-item').click(function() {
    ...
    if ($this.attr('class') === "dropdown-item active") {
      ...
      $('.selected-item').text(langArr.toString());
        $('.lan-list .addonInput').append(`<div class="sel-lang-block ${selectedLang}" > <div class="language-title">${selectedLang}</div> <div class="bannerInput-group"> <span class="banner-label">title</span> <input type="text" class="login-fields login-title" placeholder="title"> </div> <div class="bannerInput-group"> <span class="banner-label">subtitle</span> <input type="text" class="login-fields login-subtitle" placeholder="subtitle"> </div> <div class="bannerInput-group"> <span class="banner-label">link text</span> <input type="text" class="login-fields login-link-input" placeholder="link text"> </div> <div class="bannerInput-group"> <span class="banner-label">link url</span> <input type="text" class="login-fields login-link-url" placeholder="link url"> </div> <div class="db-error-mgs"> <span>*Please enter the required fields</span> </div> <div class="db-btn input-submit sub-btn"> <span>Click to Preview</span> </div> </div>`);
    } else {
  ...
  if ($('.login-page').find('.screen-2')) {
    $('.login-inputs').slideUp();
  }
  ...
  $('.login-setup .theme-item').click(function() {
    ...
    $('.theme-item').click(function(){
      if($('.login-page').attr('class').indexOf('screen-3') > 0){
        ...
        $('.login-content-block span').css('color',$('.loginTitle').css('color'))
      }
    })
  ...
  //             left: "0px"
  //         }, 300)
  //         $(this).find('.icon').removeClass('icon-back');
  //         $(this).find('.icon').addClass('icon-setting')
  //     }
  // });


  /*****new setting btn code *****/
...
$(document).ready(function(){
  ...
  console.log($('.login-page').css('height'));

if(parseInt($('.login-page').css('height')) < 600){
  $('.login-body').addClass('small-height-screen')
}
